...
// TODO: remettre 'http://localhost:3000' pour faire fonctionner en local
const API = 'http://187.124.51.179:3000';
// TODO: remettre crypto.randomUUID() seul pour faire fonctionner en localhost (contexte sécurisé)
const SESSION_ID = sessionStorage.getItem('sid') || (crypto.randomUUID?.() ?? Math.random().toString(36).slice(2));
